"""bismillah_26980 URL Configuration
...
admin.site.site_header = "BISMILLAH"
admin.site.site_title = "BISMILLAH Admin Portal"
admin.site.index_title = "BISMILLAH Admin"

# swagger
api_info = openapi.Info(
    title="BISMILLAH API",
    default_version="v1",
    description="API documentation for BISMILLAH App",
)
